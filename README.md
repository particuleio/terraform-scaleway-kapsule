...
| <a name="input_autoscaler_config"></a> [autoscaler\_config](#input\_autoscaler\_config) | The configuration options for the Kubernetes cluster autoscaler | <pre>object({<br/>    disable_scale_down               = optional(bool)<br/>    scale_down_delay_after_add       = optional(string)<br/>    scale_down_unneeded_time         = optional(string)<br/>    estimator                        = optional(string)<br/>    expander                         = optional(string)<br/>    ignore_daemonsets_utilization    = optional(bool)<br/>    balance_similar_node_groups      = optional(bool)<br/>    expendable_pods_priority_cutoff  = optional(number)<br/>    scale_down_utilization_threshold = optional(number)<br/>    max_graceful_termination_sec     = optional(number)<br/>    log_level                        = optional(number)<br/>    skip_nodes_with_local_storage    = optional(bool)<br/>  })</pre> | `{}` | no |
